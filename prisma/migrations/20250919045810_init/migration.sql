...
CREATE TABLE "AwsConfig" (
    ...
    "kmsKeyId" TEXT,
    "customKey" TEXT,
    "encryptionMethod" TEXT NOT NULL DEFAULT 'awsManaged',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "AwsConfig_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "AwsConfig_userId_key" ON "AwsConfig"("userId");
